        ...
        public IApplicationBuilder UseMiddleware(IApplicationBuilder app)
        {
            try
            {
                using (var scope = app.ApplicationServices.CreateScope())
                {
                    ...
                    SenparcTrace.SendCustomLog("Senparc.Xscf.WeixinManager 搜索 MessageHandler", $"搜索到 {messageHandlerTypes.Count()} 个");
            ...
            {
                SenparcTrace.SendCustomLog("Senparc.Xscf.WeixinManager IXscfMiddleware 异常", ex.Message);
